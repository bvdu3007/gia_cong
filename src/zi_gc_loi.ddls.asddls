...
define view entity zi_gc_loi
  as select from ztb_gc_loi
  association        to parent ZI_BB_GC as _hdr on  $projection.HdrId = _hdr.HdrId
//  association [1..1] to ZR_TB_LOI_H_DTL as _loi on  $projection.LoaiLoi   = _loi.LoaiLoi
//                                                and $projection.ErrorCode = _loi.ErrorCode
